                                                              ...
                                                              //    SoftwareSerial bluetoo(10, 11); // RX, TX
                   ...
                   void setup() {//abre SETUP                                        
                                        ...
                                        //********************* 
                                                  ...
                                                  pinMode(ledPiscar, OUTPUT);//azul
                                                               ...
                                                               digitalWrite(6,LOW);
                                                                     delay(100);
                                                                                    digitalWrite(7,HIGH);//os 2 leds ao mesmo tempo
                                                                                    digitalWrite(6,HIGH);
                                                                                          delay(500);
                                                                                    digitalWrite(7,LOW);
                                                                                    digitalWrite(6,LOW);
                                                               ...
                                                               if(LDR >=500 ){       //abre if LDR
                                                                ...
                                                                if(((millis() - delayl) > 10) && (t != "")){
                                                                  ...
                                                                  delay(8000);
                                                                             ...
                                                                             }// fecha ultimo digitalWrite
                                                                             }// fecha penultimo digitalWrite
                                                                             //********************
